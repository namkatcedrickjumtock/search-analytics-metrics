...
// Map Recharts dataKey → Tailwind text/bg classes so we avoid all inline styles
const SERIES_CLASSES: Record<string, { dot: string; val: string }> = {
  Avg: { dot: "bg-slate-400",  val: "text-slate-300"  },
  ...
  return (
    <ResponsiveContainer width="100%" height={220}>
      <LineChart data={display} margin={{ top: 4, right: 8, bottom: 0, left: 0 }}>
        ...
        <Line type="monotone" dataKey="avg" name="Avg"  stroke="#94a3b8" strokeWidth={1.5} dot={false} isAnimationActive={false} />
